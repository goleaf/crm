...
final class KnowledgeArticleApprovalObserverTest extends TestCase
{
    ...
    {
        $this->markTestIncomplete('Test for saving needs implementation');
    }

    public function test_saved(): void
    {
        $this->markTestIncomplete('Test for saved needs implementation');
    }
}
