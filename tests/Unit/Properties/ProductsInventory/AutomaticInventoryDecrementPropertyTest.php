...
it('automatically decrements inventory for product sales', function (): void {
    // Create test data
...
it('automatically decrements inventory for variation sales', function (): void {
    // Create test data
    $team = Team::factory()->create();
    $user = User::factory()->create();
    $user->teams()->attach($team);
...
it('handles multiple sales correctly', function (): void {
    // Create test data
    $team = Team::factory()->create();
    $user = User::factory()->create();
    $user->teams()->attach($team);
...
it('prevents negative inventory from sales', function (): void {
    // Create test data
    $team = Team::factory()->create();
    $user = User::factory()->create();
    $user->teams()->attach($team);
...
it('handles returns correctly by incrementing inventory', function (): void {
    // Create test data
    $team = Team::factory()->create();
    $user = User::factory()->create();
    $user->teams()->attach($team);
...
it('handles sales with reserved inventory correctly', function (): void {
    // Create test data
    $team = Team::factory()->create();
    $user = User::factory()->create();
    $user->teams()->attach($team);
...
it('ignores sales for non-tracked inventory items', function (): void {
    // Create test data
    $team = Team::factory()->create();
    $user = User::factory()->create();
    $user->teams()->attach($team);
