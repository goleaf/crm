 ...
 */
it('sorts products correctly by name in ascending order', function (): void {
...
it('sorts products correctly by name in descending order', function (): void {
    $team = Team::factory()->create();
...
it('sorts products correctly by SKU in ascending order', function (): void {
    $team = Team::factory()->create();
...
it('sorts products correctly by price in ascending order', function (): void {
    $team = Team::factory()->create();
...
it('sorts products correctly by price in descending order', function (): void {
    $team = Team::factory()->create();
...
it('sorts products correctly by creation date in ascending order', function (): void {
    $team = Team::factory()->create();
...
it('sorts products correctly by creation date in descending order', function (): void {
    $team = Team::factory()->create();
 ...
 */
it('handles null values correctly when sorting', function (): void {
    $team = Team::factory()->create();
 ...
 */
it('applies multiple sort criteria in the correct order', function (): void {
    $team = Team::factory()->create();
