...
it('calculates available inventory correctly for products', function () {
    // Create test data
...
it('calculates available inventory correctly for variations', function () {
    // Create test data
    $team = Team::factory()->create();
    $user = User::factory()->create();
    $user->teams()->attach($team);
...
it('handles inventory reservation correctly', function () {
    // Create test data
    $team = Team::factory()->create();
    $user = User::factory()->create();
    $user->teams()->attach($team);
...
it('handles inventory release correctly', function () {
    // Create test data
    $team = Team::factory()->create();
    $user = User::factory()->create();
    $user->teams()->attach($team);
...
it('handles products with variations correctly', function () {
    // Create test data
    $team = Team::factory()->create();
    $user = User::factory()->create();
    $user->teams()->attach($team);
...
it('returns unlimited inventory for non-tracked items', function () {
    // Create test data
    $team = Team::factory()->create();
    $user = User::factory()->create();
    $user->teams()->attach($team);
...
it('maintains calculation consistency after adjustments', function () {
    // Create test data
    $team = Team::factory()->create();
    $user = User::factory()->create();
    $user->teams()->attach($team);
