...
final class PeopleRepositoryInterfaceTest extends TestCase
{
    ...
    public function test_by_company(): void
    {
        $this->markTestIncomplete('Test for byCompany needs implementation');
    }
}
