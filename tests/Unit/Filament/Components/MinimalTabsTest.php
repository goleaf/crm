...
it('extends Filament Schemas Tabs component', function () {
...
it('applies minimal styling by default', function () {
    $tabs = MinimalTabs::make('Test');
...
it('can disable minimal styling', function () {
...
it('can apply compact styling', function () {
...
it('can disable compact styling', function () {
...
it('can chain minimal and compact styling', function () {
    $tabs = MinimalTabs::make('Test')
        ->minimal()
        ->compact();
...
it('uses correct view path', function () {
    $tabs = MinimalTabs::make('Test');
...
it('can be configured with tabs', function () {
    $tabs = MinimalTabs::make('Test')
        ->tabs([
...
it('can handle empty tabs array', function () {
...
it('preserves extra attributes when applying styling', function () {
    $tabs = MinimalTabs::make('Test')
        ->minimal()
        ->compact();
...
it('can be configured with parent methods', function () {
    $tabs = MinimalTabs::make('Test')
        ->columnSpanFull()
        ->contained()
...
it('handles CSS class management correctly', function () {
    $tabs = MinimalTabs::make('Test');
...
it('maintains class order when adding and removing classes', function () {
    $tabs = MinimalTabs::make('Test')
    ...
    $classes = explode(' ', $tabs->getExtraAttributes()['class']);
...
it('handles null and empty label correctly', function () {
    $tabsWithNull = MinimalTabs::make(null);
...
it('preserves view path correctly', function () {
    $tabs = MinimalTabs::make('Test')
        ->minimal()
        ->compact();
...
it('handles complex class manipulation scenarios', function () {
    $tabs = MinimalTabs::make('Test')
