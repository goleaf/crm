 ...
 */
it('performs class operations efficiently with large class lists', function () {
...
it('handles memory efficiently with repeated operations', function () {
...
it('scales linearly with class count', function () {
...
it('maintains consistent performance across different operations', function () {
    ...
    $operations = [
        fn () => $tabs->minimal(),
        fn () => $tabs->compact(),
        fn () => $tabs->minimal(false),
        fn () => $tabs->compact(false),
    ];
