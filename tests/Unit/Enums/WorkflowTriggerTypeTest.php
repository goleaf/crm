...
describe('WorkflowTriggerType enum', function () {
    ...
    it('can be safely instantiated with tryFrom', function () {
    ...
    it('has unique values', function () {
        $values = array_map(fn ($case) => $case->value, WorkflowTriggerType::cases());
    ...
    it('translation keys follow correct pattern', function () {
    ...
    it('supports all trigger types for workflow automation', function () {
        // Verify we have the essential trigger types for workflow automation
        $triggerTypes = array_map(fn ($case) => $case->value, WorkflowTriggerType::cases());
