...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Module Scanned Paths
    |--------------------------------------------------------------------------
    |
    | The TranslationCheckerService will automatically scan these paths for
    | translation files in addition to the default lang_path().
    |
    */
    'module_paths' => [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Configuration for caching translation data.
    |
    */
    'cache' => [
