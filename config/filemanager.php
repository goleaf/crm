...
return [
    ...
    |
    */
    'mode' => env('FILEMANAGER_MODE', 'database'), // 'database' or 'storage'
    ...
    */
    'file_manager' => [
        ...
        'navigation' => [
            ...
            'label' => (app()->bound('translator') ? __('app.navigation.file_manager') : 'File Manager'),
            'sort' => 110,
            'group' => (app()->bound('translator') ? __('app.navigation.system') : 'System'),
        ],
    ],
    ...
    */
    'file_system' => [
        ...
        'navigation' => [
            ...
            'label' => (app()->bound('translator') ? __('app.navigation.file_system') : 'File System'),
            'sort' => 111,
            'group' => (app()->bound('translator') ? __('app.navigation.system') : 'System'),
        ],
    ],
