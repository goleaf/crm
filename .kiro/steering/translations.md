...
## Source of truth
- Use PHP translation files (`resources/lang/{locale}/*.php`) as the source of truth. JSON files generated by `laravel-auto-translations` are tooling artifacts (gitignored); always convert them back with `auto-translations:json-to-php {locale} --import` before shipping.
