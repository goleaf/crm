        ...
        return $schema
            ->components([
                ...
                Section::make('Status & Routing')
                    ->description('Lead status, source, and assignment')
                    ->schema([
                        Select::make('status')
                ...
                Section::make('Nurturing')
                    ->description('Lead nurturing program and schedule')
                    ->schema([
                ...
                Section::make('Qualification & Conversion')
                    ->description('Qualification and conversion tracking')
                    ->schema([
                ...
                Section::make('Data Quality')
                    ->description('Duplicate detection and web form data')
                    ->schema([
