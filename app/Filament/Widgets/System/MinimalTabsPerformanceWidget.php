 ...
 */
final class MinimalTabsPerformanceWidget extends BaseWidget
{
    ...
    private function getComponentStatus(): string
    {
        ...
        return $parentClass->getName() === \Filament\Schemas\Components\Tabs::class
            ? 'Compatible'
            : 'Needs Update';
    }
    ...
    private function getMemoryEfficiency(): string
    {
        ...
        $memoryIncrease = ($finalMemory - $initialMemory) / 1024;
        // KB
        if ($memoryIncrease < 1) {
            return 'Optimal';
        }
